...
/**
 * /products/[id] — a product's canonical Form View (its permanent address).
 * Part of the app-wide Universal Record Drill-Down standard: any RecordLink to
 * a product lands here. Deep-linkable (notifications, reports, the back stack)
