      ...
      <div className="max-w-2xl mx-auto px-4 py-4">
        ...
        <div className="relative mb-3">
          ...
          <input
            ...
            className="w-full h-11 pl-10 pr-3 rounded-xl border border-gray-200 bg-white text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
        ...
        {loading ? (
          ...
          <div className="bg-red-50 border border-red-200 rounded-xl p-4 text-center space-y-3">
            ...
            <button
              type="button"
              onClick={load}
              className="min-h-[44px] px-4 text-sm font-semibold text-blue-600 hover:text-blue-700"
            >
              Try again
            </button>
          </div>
  ...
  return (
    <div className={`flex items-stretch bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden ${deleting ? 'opacity-50' : ''}`}>
      <button
        ...
        onClick={onOpen}
        disabled={deleting}
        className="flex-1 min-w-0 text-left px-4 py-3.5 hover:bg-blue-50/40 active:bg-blue-50 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-blue-500 disabled:pointer-events-none"
      >
    ...
    <div className="fixed inset-0 z-[100] bg-black/40 flex items-end sm:items-center justify-center" onClick={() => { if (!submitting) onClose(); }}>
      ...
      >
        <div className="bg-blue-600 text-white px-4 py-3 rounded-t-2xl">
          <p className="text-[11px] font-bold uppercase tracking-wide text-blue-100">Guide Library</p>
