          ...
          <div className="px-3 py-1">
            ...
            {!isCandidate && (
              <>
                ...
                {canSee('shift-handover') && (
                  <NavItem label="Shift Handover" href="/shift-handover" current={pathname} onClick={navigate}
                    icon={<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="23 4 23 10 17 10"/><polyline points="1 20 1 14 7 14"/><path d="M3.51 9a9 9 0 0114.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0020.49 15"/></svg>} />
                )}
                {canSee('products') && (
                  <NavItem label="Products" href="/products" current={pathname} onClick={navigate}
                ...
                {canSee('shifts') && (
                  <NavItem label="Planning" href="/shifts" current={pathname} onClick={navigate}
                ...
                {canSee('tasks') && (
                  <NavItem label="My Tasks" href="/tasks" current={pathname} onClick={navigate}
                    icon={<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 11 12 14 22 4"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/></svg>} />
                )}
                {canSee('prep-planner') && (
                  <NavItem label="Prep Planner" href="/prep-planner" current={pathname} onClick={navigate}
                ...
                {canSee('cooktimer') && (
                  <NavItem label="Cooking Timer" href="/cooktimer-setup" current={pathname} onClick={navigate}
                    icon={<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>} />
                )}
                {canSee('sales') && (
                  <NavItem label="Sales" href="/sales" current={pathname} onClick={navigate}
                ...
                {canSee('rentals') && (
                  <NavItem label="Rentals" href="/rentals" current={pathname} onClick={navigate}
                    icon={<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 21h18"/><path d="M5 21V7l8-4v18"/><path d="M19 21V11l-6-4"/></svg>} />
                )}
              </>
            )}
