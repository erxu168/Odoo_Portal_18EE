...
export default function EditRecipeOverview({
  ...
  onEditMetadata, onEditSteps, onEditIngredients, onTogglePublish, onDelete, onBack, onHome,
}: Props) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      {/* Header */}
      <AppHeader title={recipeName} subtitle="Edit recipe" showBack onBack={onBack} />
      ...
      <div className="px-5 pt-5 pb-8 flex-1">
        ...
        <div className="flex flex-col gap-3 mb-5">
          ...
          <button
            ...
            className={`w-full py-4 rounded-2xl text-[15px] font-bold border ${accentLight} active:opacity-80 flex items-center justify-center gap-2`}
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 3v18M3 7l9-4 9 4M5 7v6a7 7 0 0014 0V7"/></svg>
            Edit Amounts
          </button>
          <button
