      ...
      <div className="bg-[#1A1F2E] px-5 pt-14 pb-5">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-[12px] text-white/50">Chef Guide preferences</p>
          </div>
        </div>
      </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.02] overflow-hidden">
          ...
          >
            ...
            <div className="flex-1 text-left">
              ...
              <div className="text-[12px] text-white/40">Timer alerts, sounds, vibration</div>
            </div>
            <svg
          ...
          {expanded === 'notifications' && (
            <div className="px-4 pb-5 space-y-6 border-t border-white/5 pt-4">
              ...
              {/* Alert Sound */}
              <section>
                <h2 className="text-[13px] font-bold text-white/50 uppercase tracking-wider mb-3">Alert Sound</h2>
                  ...
                  {soundKeys.map((key) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className={`flex-1 text-left text-[15px] font-semibold ${selected ? 'text-green-400' : 'text-white/80'}`}>{s.label}</span>
                        <div
                          onClick={(e) => { e.stopPropagation(); s.play(); }}
                          className="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center active:bg-white/20"
                        >
              ...
              {/* Sound Repeat */}
              <section>
                <h2 className="text-[13px] font-bold text-white/50 uppercase tracking-wider mb-3">Sound Repeat</h2>
                <p className="text-[12px] text-white/40 mb-3">How often the sound plays while the alert is showing</p>
                      ...
                      <button
                        ...
                        className={`px-4 py-2.5 rounded-xl text-[13px] font-semibold border-2 transition-colors ${
                          selected
                            ...
                            : 'border-white/10 bg-white/[0.03] text-white/60 active:bg-white/[0.06]'
                        }`}
                      >
                        {opt.label}
                      </button>
              ...
              {/* Banner Duration */}
              <section>
                <h2 className="text-[13px] font-bold text-white/50 uppercase tracking-wider mb-3">Banner Duration</h2>
                <p className="text-[12px] text-white/40 mb-3">How long the notification banner stays on screen</p>
                <div className="flex flex-wrap gap-2">
              ...
              {/* Vibration */}
              <section>
                <h2 className="text-[13px] font-bold text-white/50 uppercase tracking-wider mb-3">Vibration</h2>
                <button
                ...
                >
                  ...
                  <span className={`flex-1 text-left text-[15px] font-semibold ${local.vibration ? 'text-green-400' : 'text-white/60'}`}>
                    {local.vibration ? 'Vibration on' : 'Vibration off'}
                  </span>
                  <div className={`w-11 h-6 rounded-full transition-colors relative ${local.vibration ? 'bg-green-500' : 'bg-white/20'}`}>
