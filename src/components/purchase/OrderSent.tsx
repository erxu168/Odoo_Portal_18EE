...
export default function OrderSent({ changeTab, goHome }: OrderSentProps) {
  return (
    <div className="px-4 py-3 flex flex-col items-center pt-16">
      ...
      <button onClick={() => changeTab('order')} className="w-full max-w-[300px] py-3.5 rounded-xl bg-green-600 text-white text-[14px] font-bold shadow-lg shadow-green-600/30 mb-3">Place another order</button>
