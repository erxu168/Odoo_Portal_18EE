...
/**
 * Expandable info card explaining the "Rote Karte" (Gesundheitszeugnis /
 * Food Hygiene Certificate) — required for anyone working with food in Germany.
 *
 * Placed in StepDocuments and MyDocuments near the health certificate upload.
 */
export default function RoteKarteInfo() {
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="text-[12px] text-amber-700 mt-0.5">
            Required by law to handle food in Germany (IfSG §43)
          </div>
        </div>
        <svg
          width="18"
          ...
          strokeWidth="2"
          className={
            "text-amber-600 flex-shrink-0 transition-transform duration-200 " +
            (expanded ? "rotate-180" : "")
          }
        >
          <path d="M6 9l6 6 6-6" />
            ...
            <div>
              ...
              <ul className="text-[13px] text-gray-600 leading-relaxed space-y-1">
                ...
                <li className="flex gap-2">
                  ...
                  <span>
                    Upload a photo of it here. Your employer must keep it on file
                  </span>
                </li>
              </ul>
            </div>
