  ...
  return (
    <div className="fixed inset-0 z-[200] bg-black/95 flex flex-col">
      <div className="flex items-center justify-end px-4 py-3 bg-black/80 backdrop-blur-sm flex-shrink-0">
        ...
        <button onClick={onClose} className="w-[clamp(44px,12vw,55px)] h-[clamp(44px,12vw,55px)] rounded-full bg-white/10 flex items-center justify-center active:bg-white/20">
