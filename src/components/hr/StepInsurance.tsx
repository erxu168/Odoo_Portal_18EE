  ...
  return (
    <div className="pb-40">
      <div className="p-5 space-y-4">
        <div>
          <div className="flex items-center gap-1.5 mb-1.5">
            <span className="text-[13px] font-semibold text-gray-500 uppercase tracking-wide">Social security number</span>
            <span className="text-[12px] text-gray-400">(SV-Nummer)</span>
        ...
        <div>
          <div className="flex items-center gap-1.5 mb-1.5">
            <span className="text-[13px] font-semibold text-gray-500 uppercase tracking-wide">Health insurance</span>
            <span className="text-[12px] text-gray-400">(Krankenkasse)</span>
        ...
        <div>
          <div className="flex items-center gap-1.5 mb-1.5">
            <span className="text-[13px] font-semibold text-gray-500 uppercase tracking-wide">Insurance type</span>
          </div>
        ...
        <label className="flex items-start gap-3 mt-4 cursor-pointer">
          ...
          />
          <span className="text-[13px] text-gray-700">I confirm that I have read and understood the health insurance requirements above and will provide proof of valid health insurance to my employer.</span>
        </label>
      </div>
      <div className="fixed bottom-16 left-0 right-0 max-w-[430px] mx-auto p-5 bg-gradient-to-t from-[#f8faf9] via-[#f8faf9] to-transparent flex gap-3">
        ...
        <button onClick={handleSubmit} disabled={saving || !acknowledged} className="flex-1 py-4 bg-green-600 text-white font-semibold rounded-xl active:opacity-85 disabled:opacity-40">
