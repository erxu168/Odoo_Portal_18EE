    ...
    <div className="pb-8">
      <div className="p-5">
        ...
        >
          ...
          <FilePicker facing="user" onFile={(file, dataUrl) => { handlePhotoFile({ target: { files: [file] } } as any); }} accept="image/*" className="w-full flex items-center justify-center gap-2 py-3.5 bg-white border border-gray-200 rounded-xl active:bg-gray-50 active:shadow-lg transition-all disabled:opacity-40">
