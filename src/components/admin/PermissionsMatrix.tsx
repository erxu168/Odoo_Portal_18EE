...
const MODULE_LABEL: Record<string, string> = { shifts: 'Shifts', manufacturing: 'Manufacturing', purchase: 'Purchase', inventory: 'Inventory', 'prep-planner': 'Prep Planner', recipes: 'Chef Guide', credentials: 'Supplier Logins', tasks: 'My Tasks' };
