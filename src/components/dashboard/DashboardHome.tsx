...
const TILES: Tile[] = [
  ...
  {
    id: 'kds', label: 'Kitchen Display', subtitle: 'Live order tracking', href: '/kds', minRole: 'staff',
    bg: 'bg-slate-800', border: 'border-slate-600', iconBg: 'bg-slate-700', iconColor: 'text-green-400',
